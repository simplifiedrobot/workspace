...
public class newspager extends basepager {
	...
	public void getData() {
		...
		http.send(HttpMethod.GET,MyURL.CATEGORIESURL, new RequestCallBack<String>() {
			@Override
			public void onSuccess(ResponseInfo<String> responseInfo) {
				result = responseInfo.result;
				System.out.println("在newspaper中获得数据"+result);
				...
				// 准备4个菜单详情页
				list.add(new newsMenuDetail(mactivity, newsbean.getData()
						.get(0)));
